...
/** The hub's hot-seat gauge — how warm is Billy's chair. The band is the story, the bar is proof. */
export function HotSeat({ pressure }: { pressure: number }) {
  ...
  return (
    <section className={`hot-seat band-${band}`} aria-label="Coach pressure">
      <div className="hot-seat-head">
        <span className="hot-seat-title">🔥 The Hot Seat · Billy Slater</span>
